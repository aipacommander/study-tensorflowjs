...
export class Agent {
    ...
    epsilonInit: any
    epsilonFinal: any
    epsilonDecayFrames: any
    epsilonIncrement_: any
    onlineNetwork: any
    targetNetwork: any
    optimizer: any
    replayBufferSize: any
    replayMemory: any
    frameCount: any
    ...
    constructor(dqn, game, config) {
        ...
        this.onlineNetwork = this.dqn.createDeepQNetwork(game.height(), game.width(), NUM_ACTIONS)
        this.targetNetwork = this.dqn.createDeepQNetwork(game.height(), game.width(), NUM_ACTIONS)
